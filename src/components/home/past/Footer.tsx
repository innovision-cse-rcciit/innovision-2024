...
export const Footer = () => {
  return (
    <div className="w-full relative bg-black py-10 flex flex-col items-center">
      ...
      <div className="flex justify-center space-x-4 sm:space-x-6 mt-6">
        <Link href="#"><img src="/home/socials/past_instagram.svg" alt="Instagram" className="h-6 w-6 sm:h-8 sm:w-8"/></Link>
        <Link href="#"><img src="/home/socials/past_facebook.svg" alt="Facebook" className="h-6 w-6 sm:h-8 sm:w-8"/></Link>
        <Link href="#"><img src="/home/socials/past_facebook.svg" alt="Discord" className="h-6 w-6 sm:h-8 sm:w-8"/></Link>
      </div>
