...
export default function Register() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const allFieldsValid = Object.values(validation).every((value) => value === "");
  ...
  return (
    <div
      className="relative min-h-screen l bg-gray-900  w-full bg-no-repeat bg-cover "
      ...
      <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between w-full max-w-7xl px-8">
        ...
        <h1 className="text-xs font-semibold text-red-600">{errors.name}</h1>
            ...
            <RegFormElement
              ...
              />
              {errors.email && (
        <h1 className="text-xs font-semibold text-red-600">{errors.email}</h1>
      )}
            </div>
            ...
            <RegFormElement
              ...
              />
              {errors.collegeRoll && (
        <h1 className="text-xs font-semibold text-red-600">{errors.collegeRoll}</h1>
      )}
            </div>

            {/* Department Dropdown */}
            <div className="mb-2">
              <label id="glow" className="text-base font-sans tracking-widest font-semibold md:text-lg" htmlFor="department">
             Department :
              </label>
              <select
                id="department"
              ...
              {errors.department && (
        <h1 className="text-xs font-semibold text-red-600">{errors.department}</h1>
      )}
            </div>

            <div className="mb-3">
              <label id="glow" className="text-base font-sans tracking-widest font-semibold md:text-lg" htmlFor="section">Section</label>
              ...
              {errors.section && (
        <h1 className="text-xs font-semibold text-red-600">{errors.section}</h1>
      )}
            </div>

            <div className="mb-3">
              <label id="glow" className="text-base font-sans tracking-widest font-semibold md:text-lg" htmlFor="year">Year</label>
              <div className="flex space-x-4">
              ...
              {errors.year && (
        <h1 className="text-xs font-semibold text-red-600">{errors.year}</h1>
      )}
            </div>
        ...
        <h1 className="text-xs font-semibold text-red-600">{errors.phone}</h1>
            ...
            <div className="mb-3">
              <label id="glow" className="text-base font-sans tracking-widest font-semibold md:text-lg" htmlFor="gender">Gender</label>
              <div className="flex space-x-4">
